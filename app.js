...
search.addEventListener("click", () => {
  const APIKey = "8f79b47924f09699703bd83d27c24c57";
    ...
    .then((json) => {
      ...
      if (cityHide.textContent == city) {
        ...
        switch (json.weather[0].main) {
          case "Clear":
            image.src = "/public/src/img/clear.png";
            break;
          case "Rain":
            image.src = "/public/src/img/rain.png";
            break;
          case "Snow":
            image.src = "/public/src/img/snow.png";
            break;
          case "Clouds":
            image.src = "/public/src/img/cloud.png";
            break;
          case "Mist":
            image.src = "/public/src/img/mist.png";
            break;
          case "Haze":
            image.src = "/public/src/img/mist.png";
            break;
